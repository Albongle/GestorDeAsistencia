...
{
    public sealed class Empleado : Persona, ICloneable
    {
        #region "Atributos"
        ...
        {
            base.FechaDeNacimiento = fechaDeNacimiento;
            base.Dni = dni;
        ...
        public string Legajo
        {
            ...
            set
            {
                ...
                {
                    throw new Exception("Legajo Erroneo");
                }
            }
        }
        ...
        private bool ValidaLegajo(string valor)
        {
            ...
            if (!string.IsNullOrWhiteSpace(valor) && base.ValidaCadenaTexto(valor, new Regex(@"^u[0-9]{6}")) && valor.Length == 7)
            {
                returnAux = true;
            }
            return returnAux;
